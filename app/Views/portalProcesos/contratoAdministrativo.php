...
<head>
    ...
    <style>
        * {
        ...
        .campo-mediano { min-width: 130px; }
        .campo-corto { min-width: 70px; }
        [contenteditable="true"] { cursor: text; outline: none; }
        .clausula { margin: 12px 0; }
        .declaracion-item { margin-left: 20px; margin-bottom: 6px; text-align: justify; }
        .lista-decimal { margin-left: 35px; }
        table {
            width: 100%;
...
<div class="contenedor-documento">
    ...
    <div class="hoja">
        ...
        <div class="contenido-hoja">
            ...
            <div style="margin: 10px 0;">[MTM/CAYS/PF/<span class="campo campo-mediano" contenteditable="true">AD-004/2026</span>]</div>
            
            <div style="font-weight: bold; font-size: 12pt; text-align: center; margin: 20px 0;">CONTRATO ADMINISTRATIVO ABIERTO PARA<br>EL <span class="campo campo-largo" contenteditable="true">"SUMINISTRO DE ARTÍCULOS DE FERRETERÍA"</span></div>
            
            <div style="text-align: justify; margin-bottom: 15px;">CONTRATO ADMINISTRATIVO QUE CELEBRAN POR UNA PARTE EL MUNICIPIO CONSTITUCIONAL DE TEMASCALCINGO, MÉXICO, REPRESENTADO EN ESTE ACTO POR LA <strong>C. VERÓNICA MORENO MARTÍNEZ</strong>, EN SU CARÁCTER DE <strong>PRESIDENTA MUNICIPAL CONSTITUCIONAL</strong>; <strong>C. RAMIRO GALINDO REYES</strong>, SECRETARIO DEL AYUNTAMIENTO; <span class="campo campo-largo" contenteditable="true">C. JUSTO MARTÍNEZ MARTÍNEZ</span> DIRECTOR DE SERVICIOS PÚBLICOS Y ÁREA USUARIA; QUIÉN EN LO SUCESIVO Y PARA LOS EFECTOS DEL PRESENTE SE LE DENOMINARÁ <strong>"EL MUNICIPIO"</strong>; Y POR OTRA PARTE EL <span class="campo campo-largo" contenteditable="true">C. MARCELINO GUTIÉRREZ GARCÍA</span>, EN SU CARÁCTER DE PERSONA FÍSICA A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ <strong>"EL PROVEEDOR"</strong>, AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:</div>
            ...
            <div class="declaracion-item">5. QUE TIENE ESTABLECIDO SU DOMICILIO EN <span class="campo campo-largo" contenteditable="true">PALACIO MUNICIPAL, TEMASCALCINGO, MÉXICO</span>, MISMO QUE SE SEÑALA PARA LOS FINES Y EFECTOS LEGALES DEL PRESENTE INSTRUMENTO.</div>
            <div class="declaracion-item">6. MANIFIESTA <strong>"EL MUNICIPIO"</strong> QUE TIENE EN SU HABER RECURSOS PECUNIARIOS PROVENIENTES DE PARTICIPACIONES FEDERALES PARA EL <span class="campo campo-mediano" contenteditable="true">"SUMINISTRO DE ARTÍCULOS DE FERRETERÍA"</span> CONFORME AL PRESUPUESTO DE EGRESOS DE LA FEDERACIÓN PARA EL EJERCICIO FISCAL 2026.</div>
    ...
    <div class="hoja">
        ...
        <div class="contenido-hoja">
            ...
            <table style="width: auto; float: right; border: none;">
                <tr style="border: none;"><td style="border: none;">SUBTOTAL</td><td style="border: none;">:</td><td style="border: none;" class="celda-editable" contenteditable="true">$9,150.00</td></tr>
                <tr style="border: none;"><td style="border: none;">I.V.A.</td><td style="border: none;">:</td><td style="border: none;" class="celda-editable" contenteditable="true">$1,464.00</td></tr>
                <tr style="border: none;"><td style="border: none;">TOTAL</td><td style="border: none;">:</td><td style="border: none;" class="celda-editable" contenteditable="true">$10,614.00</td></tr>
            </table>
...
SECRETARIO DEL AYUNTAMIENTO
            ...
            <div style="border: 1px solid black; margin-top: 15px;">
                ...
                <div style="text-align: center; padding: 15px;">
                    ...
                    <span class="campo campo-mediano" contenteditable="true">C. JUSTO MARTÍNEZ MARTÍNEZ</span><br>
