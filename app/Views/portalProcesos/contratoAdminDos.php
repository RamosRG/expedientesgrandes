...
<body>
    ...
    <div class="barra-superior">
        <span style="font-weight:bold;">📄 CONTRATO ABIERTO 2026</span>
        <div>
    ...
    <div class="contenedor-documento">
        ...
        <div class="hoja">
            <div class="contenido-hoja">
                ...
                <div style="margin: 10px 0;">[MTM/CAYS/PF/<span id="no_licitacion" contenteditable="true"></span>]</div>

                <div style="font-weight: bold; font-size: 12pt; text-align: center; margin: 20px 0;">CONTRATO ADMINISTRATIVO ABIERTO PARA<br>EL "SUMINISTRO DE ARTÍCULOS DE <span id="nombre_estudio13" class="campo campo-largo" contenteditable="true">"</span></div>
                ...
                <div class="declaracion-item">6. MANIFIESTA <strong>"EL MUNICIPIO"</strong> QUE TIENE EN SU HABER RECURSOS PECUNIARIOS PROVENIENTES DE PARTICIPACIONES FEDERALES PARA EL <span id="nombre_estudio_ganador" class="campo campo-mediano" contenteditable="true">"SUMINISTRO DE ARTÍCULOS DE <span id="nombre_estudio7" class="campo campo-largo" contenteditable="true">"</span> CONFORME AL PRESUPUESTO DE EGRESOS DE LA FEDERACIÓN PARA EL EJERCICIO FISCAL 2026.</div>
                ...
                <div class="declaracion-item">1. QUE ESTÁ CONSTITUIDO LEGALMENTE COMO <span id="nombre_proveedor" class="campo campo-largo" contenteditable="true"></span>, SEGÚN CONSTA EN EL ACTA DE NACIMIENTO NÚMERO <span id="acta_nacimiento" class="campo campo-mediano" contenteditable="true">171, LIBRO 1, OFICIALIA 0001</span>, CON CLAVE ÚNICA DE REGISTRO DE POBLACIÓN (CURP) <span id="curp" class="campo campo-mediano" contenteditable="true"></span>, REGISTRADO EN EL MUNICIPIO DE TEMASCALCINGO, ESTADO DE MÉXICO EL DÍA <span id="created_at2" class="campo campo-mediano" contenteditable="true"></span>, MISMO QUE SE ACREDITA CON IDENTIFICACIÓN OFICIAL CON NÚMERO DE FOLIO <span class="campo campo-mediano" contenteditable="true">INE123456789</span> EMITIDA POR EL INSTITUTO NACIONAL ELECTORAL.</div>
                <div class="declaracion-item">2. QUE PARA EFECTOS DEL PRESENTE CONTRATO EL <span id="nombre_proveedor1" class="campo campo-largo" contenteditable="true"></span>, SEÑALA COMO SU DOMICILIO FISCAL UBICADO EN <span id="domicilio_fiscal1" class="campo campo-largo" contenteditable="true"></span> NÚMERO DE TELÉFONO <span id="telefono_principal" class="campo campo-mediano" contenteditable="true"></span> Y CORREO ELECTRÓNICO <span id="correo" class="campo campo-mediano" contenteditable="true"></span>.</div>
                <div class="declaracion-item">3. QUE CUENTA CON EL DEBIDO REGISTRO FEDERAL DE CONTRIBUYENTES <span id="rfc" class="campo campo-mediano" contenteditable="true"></span>, CON ACTIVIDAD ECONÓMICA SUMINISTRO DE<span id="nombre_estudio1" class="campo campo-mediano" contenteditable="true"></span>.</div>
                <div class="declaracion-item">4. QUE CONOCE LAS ESPECIFICACIONES DEL PROCEDIMIENTO DE ADJUDICACIÓN DIRECTA REFERENTE AL SUMINISTRO DE<span id="nombre_estudio2" class="campo campo-mediano" contenteditable="true"></span> EL CUAL LLEVA A CABO EL MUNICIPIO DE TEMASCALCINGO Y DEMÁS DOCUMENTOS QUE SE ENCUENTRAN INTEGRADOS AL EXPEDIENTE QUE SE FORMÓ CON MOTIVO DEL PROCEDIMIENTO DE ADQUISICIÓN ANTES REFERIDO.</div>
                ...
                <div class="declaracion-item">6. QUE CONOCE PLENAMENTE LAS DISPOSICIONES, QUE PARA EL CASO DE LA CONTRATACIÓN DE SERVICIOS.</div>
                <div class="declaracion-item">7. SE ESTABLECE EN LA CONSTITUCIÓN POLÍTICA DE LOS ESTADOS UNIDOS MEXICANOS, LA CONSTITUCIÓN POLÍTICA DEL ESTADO LIBRE Y SOBERANO DE MÉXICO, LA LEY DE CONTRATACIÓN PÚBLICA DEL ESTADO DE MÉXICO Y MUNICIPIOS, ASÍ COMO SU RESPECTIVO REGLAMENTO.</div>
                <div class="declaracion-item">8. QUE BAJO PROTESTA DE DECIR VERDAD LA PERSONA QUE REPRESENTA NO SE ENCUENTRA EN NINGUNO DE LOS SUPUESTOS QUE ESTABLECE EL ARTÍCULO 74 DE LA LEY DE CONTRATACIÓN PÚBLICA DEL ESTADO DE MÉXICO Y MUNICIPIOS.</div>
        ...
        <div class="hoja">
            ...
            <div class="contenido-hoja">
                ...
                <div class="clausula"><strong>PRIMERA. - OBJETO.</strong> EL PRESENTE CONTRATO TIENE POR OBJETO QUE <strong>"EL PROVEEDOR"</strong> SUMINISTRE A <strong>"EL MUNICIPIO"</strong> ARTÍCULOS DE<span id="nombre_estudio5" class="campo campo-mediano" contenteditable="true"> OBLIGÁNDOSE A ENTREGAR LOS BIENES EN LAS CANTIDADES, ESPECIFICACIONES TÉCNICAS, CALIDAD Y PLAZOS ESTABLECIDOS, GARANTIZANDO QUE LOS MISMOS SE ENCUENTREN EN ÓPTIMAS CONDICIONES, NUEVOS, LIBRES DE DEFECTOS Y APEGADOS A LAS CARACTERÍSTICAS REQUERIDAS.</div>
                ...
                <div class="declaracion-item">b) PODRÁN ADQUIRIRSE PRODUCTOS QUE NO ESTÉN EN EL LISTADO, DE ACUERDO A LAS NECESIDADES PROPIAS DE LAS DEPENDENCIAS DEL MUNICIPIO Y QUE SEAN CONSIDERADOS DENTRO DE LA PARTIDA PRESUPUESTAL <span id="nombre_estudio4" class="campo campo-mediano" contenteditable="true">2026</span>.</div>
...
<table style="width: auto; float: right; border: none;">
    <tr style="border: none;">
        ...
        <td style="border: none;" class="celda-editable subtotal-valor" contenteditable="true"></td>
    </tr>
    <tr style="border: none;">
        <td style="border: none;">I.V.A.</td>
        <td style="border: none;">:</td>
        <td style="border: none;" class="celda-editable iva-valor" contenteditable="true"></td>
    </tr>
    <tr style="border: none;">
        <td style="border: none;">TOTAL</td>
        <td style="border: none;">:</td>
        <td style="border: none;" class="celda-editable total-valor" contenteditable="true"></td>
    </tr>
</table>
                <div style="clear: both;"></div>

                <div class="clausula"><strong>SEGUNDA. -- MONTOS.</strong> LA CANTIDAD A PAGAR POR PARTE DE <strong>"EL MUNICIPIO"</strong> SERÁ DE UN MONTO MÁXIMO POR LA CANTIDAD DE <strong><span id="total_texto_completo" class="campo campo-corto" contenteditable="true"></span>; INCLUIDO EL IMPUESTO AL VALOR AGREGADO I.V.A.</strong> Y UN MONTO MÍNIMO POR LA CANTIDAD DE <strong><span id="subtotal_texto_completo" class="campo campo-corto" contenteditable="true"></span>; INCLUIDO EL IMPUESTO AL VALOR AGREGADO I.V.A.,</strong> DIVIDIDO EN PARCIALIDADES NECESARIAS Y A LA CORRECTA PRESENTACIÓN DE LAS FACTURAS, POR EL PERIODO COMPRENDIDO DEL <span id="created_at1" class="campo campo-mediano" contenteditable="true"></span>.</div>
                ...
                <div class="clausula"><strong>QUINTA. -- FORMA DE PAGO. "LAS PARTES"</strong> ACUERDAN QUE EL PAGO POR EL "SUMINISTRO DE ARTÍCULOS DE <span id="nombre_estudio8" class="campo campo-chico" contenteditable="true">" OBJETO DEL PRESENTE CONTRATO, SE CUBRIRÁ DE LA MANERA SIGUIENTE:</div>
        ...
        <div class="hoja">
            ...
            <div class="contenido-hoja">
                ...
                <div class="declaracion-item">I. ENTREGAR A EL MUNICIPIO DE TEMASCALCINGO, MÉXICO EL SUMINISTRO DE <span id="nombre_estudio9" class="campo campo-chico" contenteditable="true"></span></div> EN TIEMPO, FORMA Y CALIDAD.
                <div class="declaracion-item">II. INFORMAR A <strong>"EL MUNICIPIO"</strong> DE CUALQUIER ANOMALÍA QUE SE PRESENTE DURANTE LA EJECUCIÓN DEL PRESENTE CONTRATO, EN CUANTO IMPIDA O DIFICULTE LLEVAR A CABO EL PROCEDIMIENTO REFERENTE AL SUMINISTRO DE<span id="nombre_estudio10" class="campo campo-chico" contenteditable="true"></span> COMUNICAR POR ESCRITO OPORTUNAMENTE A <strong>"EL MUNICIPIO"</strong> CUALQUIER CAMBIO DE DOMICILIO.</div>
                ...
                <div class="declaracion-item">I. <strong>CUMPLIMIENTO DE CONTRATO:</strong> EL CHEQUE DE CAJA, CHEQUE CERTIFICADO O FIANZA SE CONSTITUIRÁ POR EL 10% DEL IMPORTE DEL SUBTOTAL DEL CONTRATO (SIN INCLUIR EL IMPUESTO AL VALOR AGREGADO), DESPUÉS DE LOS DIEZ DÍAS HÁBILES A LA FIRMA DE CONTRATO, POR LA CANTIDAD DE <strong><span id="subtotal_texto_completo1" class="campo campo-corto" contenteditable="true"></span></strong> Y ESTARÁ VIGENTE HASTA EL CUMPLIMIENTO DEL PRESENTE CONTRATO.</div>
            ...
            <div class="contenido-hoja">
                ...
                <div style="border: 1px solid black; margin-top: 15px;">
                    ...
                    <div style="text-align: center; padding: 15px;">
                        ...
                        <span id="nombre_completo_coordinado1" class="campo campo-mediano" contenteditable="true"></span><br>
                        DIRECTOR DE <span id="area1" class="campo campo-mediano" contenteditable="true">
                    </div>
                </div>
                ...
                <div style="border: 1px solid black; margin-top: 15px;">
                    ...
                    <div style="text-align: center; padding: 15px;">
                        <div style="margin-top: 20px;"></div>
                        <span id="nombre_usuario1" class="campo campo-largo" contenteditable="true"></span><br>
    ...
    <script src="../../public/js/portalProceso/contratoAdminDos.js"></script>
