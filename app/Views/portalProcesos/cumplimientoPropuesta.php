...
<div class="contenedor-principal">
    <div class="header-superior">
        <h1><i class="fas fa-paper-plane"></i> Cumplimiento de Propuestas</h1>
        <p>Licitación Pública Nacional Presencial LPNP-002-2026</p>
    </div>
    <div class="barra-acciones">
        <div class="breadcrumb"><a href="#">Oficios</a> / <a href="#">Licitaciones</a> / Cumplimiento de propuestas</div>
    ...
    <div class="selector-container">
        <label for="selectorProveedor">
            <i class="fas fa-exchange-alt"></i> Cambiar proveedor que cumplió:
        </label>
        <select id="selectorProveedor">
            <option value="">-- Seleccionar proveedor --</option>
        </select>
        <span style="margin-left: 15px; color: #666; font-size: 10px;">
            <i class="fas fa-info-circle"></i> Selecciona el proveedor que presentó propuesta
        </span>
    </div>
            ...
            <div class="hoja">
                <div class="contenido-hoja">
                    ...
                    <div class="fecha-linea linea-derecha">
                        ...
                        <span id="created_at" class="campo-verde campo-mediano" contenteditable="true">05 DE ENERO DE 2026</span>
                    </div>
                    ...
                    <div class="fecha-linea linea-derecha">
                        ...
                        <span id="asunto" class="campo-verde campo-largo" contenteditable="true">CUMPLIMIENTO DE PROPUESTAS</span>
                    </div>

                    <!-- Oficio número - alineada a la derecha -->
                    <div class="fecha-linea linea-derecha" style="margin-bottom: 20px;">
                        <strong>LPNP- </strong>
                        <span id="no_licitacion" class="campo-verde campo-corto" contenteditable="true">LPNP-002-2026</span>
                    </div>
                    ...
                    <div class="texto-cuerpo">
                        ...
                        <span id="no_licitacion1" class="campo-verde campo-corto" contenteditable="true"></span>, para la contratación del <strong>"</strong>
                        <span id="nombre_estudio" class="campo-verde campo-mediano" contenteditable="true"></span><strong>"</strong>, el cual fue aprobado en la <strong>Segunda Sesión Ordinaria</strong> de fecha 
                        <span id="created_at1" class="campo-verde campo-mediano" contenteditable="true"></span>; me permito informarles que de acuerdo al calendario establecido en las Bases de licitación se llevó a cabo el Acto de Presentación y Apertura de Propuestas del procedimiento en mención.
                    </div>

                    <div class="texto-cuerpo">
                        Por lo anterior, me permito informarles que el licitante <strong><span id="proveedor" class="campo-verde campo-mediano" contenteditable="true"></span></strong> presentó su propuesta técnica, económica y documentación complementaria cumpliendo con los requisitos de manera cuantitativa conforme lo establecido en las Bases emitidas; por lo cual son aceptadas para su Análisis y Evaluación.
                    </div>
                    ...
                    <div class="firma-area">
                        <div class="firma-linea">
                            <strong><span id="coordinador" class="campo-verde campo-largo" contenteditable="true"></span></strong>
                        </div>
    ...
    <div class="info-proveedor">
        <h3><i class="fas fa-check-circle" style="color: #4caf50;"></i> PROVEEDOR SELECCIONADO - CUMPLIMIENTO DE PROPUESTA</h3>
        <div class="proveedor-destacado">
            <strong>Proveedor que presentó propuesta:</strong> 
            ...
            <span style="margin-left: 15px; background: #4caf50; color: white; padding: 3px 12px; border-radius: 20px; font-weight: bold; font-size: 10px;">
                <i class="fas fa-check"></i> PROPUESTA ACEPTADA
            </span>
        </div>
    </div>
...
<script src="../../public/js/portalProceso/cumplimientoPropuesta.js"></script>
