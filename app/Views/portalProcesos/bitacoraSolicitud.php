...
<div class="titulo-bitacora">
    BITÁCORA DE ENVÍO DE SOLICITUD DE COTIZACIÓN A PROVEEDORES PARA EL PROCEDIMIENTO DE</div>  
    <div class="titulo-bitacora">INVITACIÓN RESTRINGIDA NACIONAL PRESENCIAL IRNP-<span id="no_licitacion" class="campo-verde campo-chico" contenteditable="true"></span></div>
</div>
<div class="subtitulo-giro">
    PARA LA “<span id="nombre_estudio" class="campo-verde campo-mediano" contenteditable="true"></span>”
</div>
    ...
    <script src="../../public/js/portalProceso/bitacoraSolicitud.js"></script>
