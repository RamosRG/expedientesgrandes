...
<head>
    ...
    <title>Invitación Restringida | IRNP-001-2026</title>
...
<div class="contenedor-principal">
    <div class="header-superior">
        <h1><i class="fas fa-envelope"></i> Invitación Restringida Nacional Presencial</h1>
        <p id="infoEstudio">IRNP-001-2026 | Adquisición de Equipos de Cómputo</p>
    </div>
    <div class="barra-acciones">
        <div class="breadcrumb"><a href="#">Licitaciones</a> / <a href="#">Invitaciones</a> / <span id="breadcrumbLicitacion">IRNP-001-2026</span></div>
    ...
    <!-- CONTENEDOR DE HOJAS DINÁMICO -->
    <div class="contenedor-documento">
        <div class="grupo-hojas" id="contenedorHojas">
            <!-- Las hojas se generarán dinámicamente con JavaScript -->
        </div>
    </div>
</div>
...
<script src="../../public/js/portalProceso/invitacionProveedores.js"></script>
