...
<body>
    <div class="contenedor-principal">
        <div class="header-superior">
            <h1><i class="fas fa-mail-bulk"></i> LISTA DE COMPRA DE BASES</h1>
...
<div class="titulo-bitacora">
    LISTA DE COMPRA DE BASES</div>  
    <div class="titulo-bitacora">LICITACIÓN PÚBLICA NACIONAL PRESENCIAL</div> 
...
<table class="tabla-proveedores" id="tablaBitacora">
    ...
    <script src="../../public/js/portalProceso/bitacoraCompra.js"></script>
