...
.espacio-firma {
    height: 120px; /* Espacio para la firma */
}
            ...
            <div class="grupo-hojas">
                ...
                <div class="hoja">
                    ...
                    <div class="contenido-hoja">
                        ...
                        <table id="tabla_participantes" style="font-weight: bold;">
                            <thead>
                                <tr>
                                    <th>LICITANTE</th>
                                    <th>REPRESENTANTE</th>
                ...
                <div class="hoja">
                    ...
                    <div class="contenido-hoja">
                        ...
                        <table class="tabla-sin-bordes" id="tabla_tecnicas" style="font-weight: bold;">
                            <thead>
                                <tr>
                                    <th>EMPRESA</th>
                                </tr>
                ...
                <div class="hoja">
                    ...
                    <div class="contenido-hoja">
                        ...
                        <table class="tabla-sin-bordes" id="tabla_economicas" style="font-weight: bold;">
                            <thead>
                                <tr>
                                    <th>EMPRESA</th>
                                </tr>
...
<div class="firma-contenedor-unica">
    <div class="firma-unica">
        <div class="titulo-firma" id="area_firma_titulo" contenteditable="true">
            <!-- Aquí se mostrará el área con el ID -->
        </div>
        ...
        <div class="linea-firma">
            <span id="coordinador_firma"></span>
                        ...
                        <table id="tabla_firmas" style="font-weight: bold;">
                            <thead>
                                <tr>
                                    <th>LICITANTE</th>
                                    <th>REPRESENTANTE</th>
