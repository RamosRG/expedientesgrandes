...
<body>
                    ...
                    <div class="contenido-hoja">
                        ...
                        <div class="estimado-box">
                            <strong>Estimado a ejercer para el procedimiento:</strong>
                                <span class="campo-verde campo-largo" contenteditable="true" id="estimadoTotal">$ 1,285,000.00 (UN MILLÓN DOSCIENTOS OCHENTA Y CINCO MIL PESOS 00/100 M.N.)</span>
                        </div>
                        ...
                        <div class="fila-firma">
                            <div class="col-firma">
                                <div class="linea-firma">
                                    <span id="coordinador1" class="campo-verde campo-mediano" contenteditable="true" style="font-size:11pt;"></span>
                                </div>
                                    <span id="areaTexto1" class="campo-verde campo-mediano" contenteditable="true" style="font-size:11pt;">
                            </div>
                            <div class="col-firma">
                                <div class="linea-firma">
    ...
    <script src="../../public/js/portalProceso/contratoEstudioMercado.js"></script>
