...
<div class="contenedor-principal">
    <div class="header-superior">
        ...
        <p>Solicitud de oficio justificatorio y suficiencia presupuestal</p>
    </div>
            ...
            <div class="hoja">
                <div class="contenido-hoja">
                    ...
                    <div class="texto-cuerpo">
                        ...
                        <span id="created_at2" class="campo-verde campo-mediano" contenteditable="true"></span>;
                    ...
                    <div class="copia-archivo">
                        <strong>C.</strong>
                        <span id="coordinador1" class="campo-verde campo-largo" contenteditable="true"></span>
                    </div>
                    <div class="iniciales">
    ...
    <div class="info-proveedor">
        <h3><i class="fas fa-check-circle" style="color: #4caf50;"></i> PROVEEDOR SELECCIONADO PARA EL ESTUDIO</h3>
        <div class="proveedor-destacado">
            <strong>Proveedor del estudio de mercado:</strong> 
        ...
        <div style="margin-top: 10px; font-size: 11px; color: #555;">
            <i class="fas fa-info-circle"></i> El proveedor seleccionado se mostrará en el cuerpo del oficio de remisión
        </div>
    </div>
