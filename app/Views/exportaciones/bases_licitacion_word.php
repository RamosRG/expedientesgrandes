<?php
// Función para convertir números a letras - SIN redeclaración de funciones internas
function numeroALetrasBases($numero) {
    ...
    // Función recursiva para convertir - DEFINIDA UNA SOLA VEZ
    if (!function_exists('convertirNumeroBasesInterna')) {
        function convertirNumeroBasesInterna($n) {
            $unidades = ['', 'UN', 'DOS', 'TRES', 'CUATRO', 'CINCO', 'SEIS', 'SIETE', 'OCHO', 'NUEVE'];
            $especiales = [
                10 => 'DIEZ', 11 => 'ONCE', 12 => 'DOCE', 13 => 'TRECE', 14 => 'CATORCE', 15 => 'QUINCE',
                16 => 'DIECISÉIS', 17 => 'DIECISIETE', 18 => 'DIECIOCHO', 19 => 'DIECINUEVE',
            ...
            if ($n < 100) {
                ...
                return $unidad === 0 ? $decenas[$decena/10] : $decenas[$decena/10] . ' Y ' . $unidades[$unidad];
            }
            if ($n < 1000) {
                $centena = floor($n / 100);
                $resto = $n % 100;
                if ($centena === 1 && $resto === 0) return 'CIEN';
                if ($centena === 1) return 'CIENTO ' . convertirNumeroBasesInterna($resto);
                return $centenas[$centena] . ' ' . convertirNumeroBasesInterna($resto);
            }
            if ($n < 1000000) {
                $miles = floor($n / 1000);
                $resto = $n % 1000;
                if ($miles === 1) {
                    return $resto === 0 ? 'MIL' : 'MIL ' . convertirNumeroBasesInterna($resto);
                }
                return convertirNumeroBasesInterna($miles) . ' MIL ' . convertirNumeroBasesInterna($resto);
            }
            return $n;
        }
    }
    ...
    $texto = convertirNumeroBasesInterna($entero);
...
<head>
    <meta charset="UTF-8">
    <title>Bases de Licitación</title>
    <!--[if gte mso 9]>
    <xml>
        <w:WordDocument>
            <w:View>Print</w:View>
...
<div class="hoja">
    <div class="contenido-hoja">
        ...
        <div style="text-align: center; font-weight: bold; font-size: 11pt; margin: 20px 0;">
            ...
            LPNP-<span class="campo-dato"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span>
            <br>PARA EL "<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"
        </div>
        ...
        <table style="border-collapse: collapse; width: 100%;">
            ...
            <tr>
                ...
                <td style="border: none; padding: 5px 0; vertical-align: top; text-align: justify;"><span class="campo-dato"><?= isset($data[0]['domicilio_proveedor']) ? esc($data[0]['domicilio_proveedor']) : '' ?></span></td>
            </tr>
            <tr>
                ...
                <td style="border: none; padding: 5px 0; vertical-align: top; text-align: justify;">2026</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none; padding: 5px 0; vertical-align: top; text-align: justify;">PERSONA <span class="campo-dato"><?= isset($data[0]['tipo_persona']) ? esc($data[0]['tipo_persona']) : '' ?></span> O JURÍDICO COLECTIVA QUE SE REGISTRE Y PARTICIPE EN EL PRESENTE PROCEDIMIENTO (QUE ACREDITE INTERÉS LEGAL POR HABER ADQUIRIDO LAS BASES DE LA LICITACIÓN).</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none; padding: 5px 0; vertical-align: top; text-align: justify;">NO. OFICIO. MTM/DAYDP/<span class="campo-dato"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span></td>
            </tr>
            <tr>
                ...
                <td style="border: none; padding: 5px 0; vertical-align: top; text-align: justify;">OFICIO NO. MTM/TM/<span class="campo-dato"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span></td>
            </tr>
            <tr>
        ...
        <div class="numero-pagina">1 DE 19</div>
    </div>
</div>
...
<div class="hoja">
    <div class="contenido-hoja">
        ...
        <div class="declaracion-item">b) LA PRESENTE LICITACIÓN SE REFIERE AL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</strong> CUYAS ESPECIFICACIONES, UNIDAD DE MEDIDA, CANTIDADES Y REQUISITOS SE DETALLAN EN EL <strong>"ANEXO 1" (PROPUESTA TÉCNICA)</strong>, DE LAS PRESENTES BASES.</div>

        <div class="clausula"><strong>2. VIGENCIA DEL CONTRATO</strong></div>
        <div class="declaracion-item">a) <span class="campo-dato">A PARTIR DEL <?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?> AL 31 DE DICIEMBRE DE 2026.</span></div>
        ...
        <div class="declaracion-item">a) LAS PRESENTES BASES TENDRÁN UN COSTO DE <strong><span class="campo-dato">
            <?php 
            $total = isset($data[0]['total']) ? floatval($data[0]['total']) : 0;
            if ($total > 0) {
                echo '$' . number_format($total, 2) . ' (' . numeroALetrasBases($total) . ')';
            }
            ?>
        </span></strong></div>
        ...
        <div class="numero-pagina">2 DE 19</div>
    </div>
</div>
...
<div class="hoja">
    <div class="contenido-hoja">
        ...
        <div class="numero-pagina">3 DE 19</div>
    </div>
</div>

<!-- CONTINUACIÓN DE DOCUMENTOS EN HOJA 4 -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
            <span>AYUNTAMIENTO DE TEMASCALCINGO 2025-2027</span>
        ...
        <div class="numero-pagina">4 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 5: ACTO DE PRESENTACIÓN Y APERTURA -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div class="numero-pagina">5 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 6: CALENDARIO DE EVENTOS -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td><?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?></td>
                    <td>PERIÓDICO EL SOL DE TOLUCA Y EL SOL DE MÉXICO</td>
                </tr>
                <tr>
                    <td>VENTA DE BASES</td>
                    <td>13, 17 Y 18 DE MARZO DE 2026 DE 9:00 A 13:00 HORAS</td>
                    <td>DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL, SITO EN EL EX SEMINARIO AV. DE LA PAZ ESQ. MIGUEL HIDALGO, COL. CENTRO, TEMASCALCINGO, MÉXICO, C.P. 50400</td>
                </tr>
                <tr>
                    <td>VISITA A LAS INSTALACIONES</td>
                    <td>NO APLICA</td>
                    <td>NO APLICA</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>PRESENTACIÓN Y APERTURA DE PROPUESTAS</td>
                    <td>19 DE MARZO DE 2026 A LAS 10:00 HORAS</td>
                    <td>DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL, SITO EN EL EX SEMINARIO AV. DE LA PAZ ESQ. MIGUEL HIDALGO, COL. CENTRO, TEMASCALCINGO, MÉXICO, C.P. 50400</td>
                </tr>
                <tr>
                    <td>CONTRAOFERTA (EN SU CASO)</td>
                    <td>20 DE MARZO DE 2026 A LAS 9:30 HORAS</td>
                    <td>DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL, SITO EN EL EX SEMINARIO AV. DE LA PAZ ESQ. MIGUEL HIDALGO, COL. CENTRO, TEMASCALCINGO, MÉXICO, C.P. 50400</td>
                </tr>
                <tr>
                    <td>ANÁLISIS Y EVALUACIÓN DE PROPUESTAS Y EMISIÓN DEL DICTAMEN</td>
                    <td>20 DE MARZO DE 2026 A LAS 11:00 HORAS</td>
                    <td>DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL, SITO EN EL EX SEMINARIO AV. DE LA PAZ ESQ. MIGUEL HIDALGO, COL. CENTRO, TEMASCALCINGO, MÉXICO, C.P. 50400</td>
                </tr>
                <tr>
                    <td>FECHA DE FALLO</td>
                    <td>23 DE MARZO DE 2026 A LAS 10:30 HORAS</td>
                    <td>DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL, SITO EN EL EX SEMINARIO AV. DE LA PAZ ESQ. MIGUEL HIDALGO, COL. CENTRO, TEMASCALCINGO, MÉXICO, C.P. 50400</td>
                </tr>
                <tr>
                    <td>FIRMA DEL CONTRATO</td>
                    <td>24 DE MARZO DE 2026 A LAS 10:00 HORAS</td>
                    <td>DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL, SITO EN EL EX SEMINARIO AV. DE LA PAZ ESQ. MIGUEL HIDALGO, COL. CENTRO, TEMASCALCINGO, MÉXICO, C.P. 50400</td>
                </tr>
                <tr>
                    <td>ENTREGA DE FIANZA DE CUMPLIMIENTO DE CONTRATO</td>
                    <td>DESPUÉS DE LOS DIEZ DÍAS HÁBILES A PARTIR DE LA FIRMA DEL CONTRATO</td>
                    <td>EN LA DIRECCIÓN DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="numero-pagina">6 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 7: CONDICIONES Y PROCEDIMIENTO -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div class="numero-pagina">7 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 8: CAUSAS DE DESCALIFICACIÓN Y CRITERIOS -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div class="numero-pagina">8 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 9: FIRMA DE CONTRATO Y SANCIONES -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div class="numero-pagina">9 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 10: GARANTÍAS Y ANEXOS -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div class="declaracion-item">- EL PROVEEDOR DEBERÁ GARANTIZAR QUE EL SUMINISTRO QUE SERÁ A PARTIR <strong>DEL <?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?> AL 31 DE DICIEMBRE DE 2026</strong> Y PROPORCIONARÁ TODAS LAS FACILIDADES A LOS SERVIDORES PÚBLICOS.</div>
        ...
        <div class="declaracion-item">a) LAS PRESENTES BASES SE EMITEN EL DÍA <?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?>.</div>

        <div class="numero-pagina">10 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 11: INCONFORMIDADES Y ANEXO 1 -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div style="margin-top: 25px; border-top: 2px solid #000; padding-top: 15px;">
            ...
            <div style="text-align: center;">LPNP-<span class="campo-dato"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span></div>
            <div style="text-align: center;">PARA EL "<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</div>
        </div>
        ...
        <div style="margin-top: 10px; border: 1px solid #000; padding: 8px;">
            ...
            <div style="border-bottom: 1px solid #000; min-height: 25px; margin-top: 5px;" class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></div>
        </div>
        ...
        <div style="margin-top: 15px;">
            ...
            <div style="margin-left: 20px;">- <strong>TIEMPO DE ENTREGA DE LOS BIENES:</strong> A PARTIR DEL <?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?> Y HASTA AL 31 DE DICIEMBRE DE 2026.</div>
        ...
        <div style="margin-top: 10px; text-align: center;">
            <div style="border-bottom: 1px solid #000; width: 60%; margin: 0 auto; min-height: 25px;" class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></div>
            <div><strong>PERSONA FÍSICA O REPRESENTANTE LEGAL DE</strong></div>
            <div style="border-bottom: 1px solid #000; width: 60%; margin: 5px auto; min-height: 25px;" class="campo-dato"><?= isset($data[0]['nombre_empresa']) ? esc($data[0]['nombre_empresa']) : '' ?></div>
            <div><strong>LA EMPRESA DENOMINADA</strong></div>
        </div>

        <div class="numero-pagina">11 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 12: ANEXO 2 - AFIANZADORAS -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <table style="margin-top: 5px; border: none;">
            ...
            <tr style="border: none;">
                <td style="border: none; height: 30px;" class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></td>
                <td style="border: none;" class="campo-dato">REPRESENTANTE LEGAL</td>
                <td style="border: none;"></td>
            </tr>
        </table>

        <div class="numero-pagina">12 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 13: ANEXO 3 - DATOS VIGENTES -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div style="margin-top: 10px; text-align: justify;">
            <span class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></span>, MANIFIESTO "BAJO PROTESTA DE DECIR VERDAD", QUE LOS DATOS AQUÍ ASENTADOS, SON CIERTOS Y HAN SIDO DEBIDAMENTE VERIFICADOS, ASÍ COMO QUE CUENTO CON LAS FACULTADES SUFICIENTES PARA SUSCRIBIR LA PROPUESTA EN LA PRESENTE LICITACIÓN, A NOMBRE Y REPRESENTACIÓN DE (PERSONA FÍSICA O MORAL)
        </div>

        <div style="margin-top: 15px; border: 1px solid #000; padding: 10px;">
            <div><strong><u>PERSONAS FÍSICAS O MORALES:</u></strong></div>
            <div style="margin-top: 5px;">
                <strong>REGISTRO FEDERAL DE CONTRIBUYENTES:</strong> <span class="campo-dato"><?= isset($data[0]['rfc']) ? esc($data[0]['rfc']) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>DOMICILIO:</strong> CALLE <span class="campo-dato"><?= isset($data[0]['domicilio_proveedor']) ? esc($data[0]['domicilio_proveedor']) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>TELÉFONO:</strong> <span class="campo-dato"><?= isset($data[0]['telefono_principal']) ? esc($data[0]['telefono_principal']) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>CORREO ELECTRÓNICO:</strong> <span class="campo-dato"><?= isset($data[0]['correo_proveedor']) ? esc($data[0]['correo_proveedor']) : '' ?></span>
            </div>
        </div>
        ...
        <div style="margin-top: 10px; border: 1px solid #000; padding: 10px;">
            ...
            <div style="margin-top: 5px;">
                ...
                NÚM. <span class="campo-dato"><?= isset($data[0]['num_acta_cons']) ? esc($data[0]['num_acta_cons']) : '' ?></span> FECHA <span class="campo-dato"><?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>NOTARIO PÚBLICO ANTE EL CUAL SE DIO FE:</strong> NOMBRE <span class="campo-dato"><?= isset($data[0]['notario']) ? esc($data[0]['notario']) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>OBJETO SOCIAL:</strong> <span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>FECHA Y DATOS DE SU INSCRIPCIÓN EN EL REGISTRO PÚBLICO DE COMERCIO:</strong> <span class="campo-dato">REGISTRO PÚBLICO DE COMERCIO</span>
            </div>
        </div>
        ...
        <div style="margin-top: 10px; border: 1px solid #000; padding: 10px;">
            ...
            <div style="margin-top: 5px;">
                <span class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></span>
            </div>
            <div style="margin-top: 5px;">
                <strong>DOCUMENTO QUE ACREDITA SU PERSONALIDAD Y FACULTADES:</strong> PODER NOTARIAL
            </div>
        </div>

        <div style="margin-top: 15px; font-weight: bold;">PROTESTO LO NECESARIO</div>
        <div style="margin-top: 10px;">
            <div style="border-bottom: 1px solid #000; width: 70%; min-height: 25px;" class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></div>
        ...
        <div class="numero-pagina">13 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 14: ANEXO 4 - PROPUESTA ECONÓMICA -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div style="margin-top: 10px;">
            <div style="display: inline-block; width: 60%; font-weight: bold;">
                MONTO CON LETRA <?= numeroALetrasBases($total) ?>
            </div>
            <div style="display: inline-block; width: 40%;">
                <table style="border: none; width: 100%;">
                    ...
                    <tr style="border: none;">
                        ...
                        <td style="border: none; text-align: right;">$<?= number_format($total, 2) ?></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div style="margin-top: 10px; text-align: center;">
            <div style="border-bottom: 1px solid #000; width: 60%; margin: 0 auto; min-height: 25px;" class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></div>
            <div><strong>PERSONA <span class="campo-dato"><?= isset($data[0]['tipo_persona']) ? esc($data[0]['tipo_persona']) : '' ?></span> O REPRESENTANTE LEGAL DE</strong></div>
            <div style="border-bottom: 1px solid #000; width: 60%; margin: 5px auto; min-height: 25px;" class="campo-dato"><?= isset($data[0]['nombre_empresa']) ? esc($data[0]['nombre_empresa']) : '' ?></div>
            <div><strong>LA EMPRESA DENOMINADA</strong></div>
        </div>

        <div class="numero-pagina">14 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJAS 15-19: ANEXO 5 - MODELO DE CONTRATO -->
<!-- ========================================== -->
<!-- HOJA 15: ANEXO 5 - MODELO DE CONTRATO (INICIO) -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
            <span>AYUNTAMIENTO DE TEMASCALCINGO 2025-2027</span>
        ...
        <div style="margin-top: 10px; text-align: center; font-weight: bold;">
            MTM/CAYS/PF/<span class="campo-dato"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span>
        </div>

        <div style="margin-top: 10px; text-align: center; font-weight: bold; font-size: 11pt;">
            CONTRATO ABIERTO PARA EL "<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"
        </div>

        <div style="margin-top: 10px; text-align: justify;">
            CONTRATO QUE CELEBRAN POR UNA PARTE EL MUNICIPIO CONSTITUCIONAL DE TEMASCALCINGO, MÉXICO, REPRESENTADO EN ESTE ACTO POR LA <strong>C. VERÓNICA MORENO MARTÍNEZ</strong>, EN SU CARÁCTER DE PRESIDENTA MUNICIPAL CONSTITUCIONAL; <strong>C. RAMIRO GALINDO REYES</strong>, SECRETARIO DEL AYUNTAMIENTO; <strong>C. MIRIAM VIANEY OVANDO RUBIO</strong> DIRECTORA DE ADMINISTRACIÓN Y DESARROLLO DE PERSONAL Y ÁREA USUARIA; QUIÉN EN LO SUCESIVO Y PARA LOS EFECTOS DEL PRESENTE SE LE DENOMINARÁ <strong>"EL MUNICIPIO"</strong>; Y POR OTRA PARTE EL <span class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></span>, EN SU CARÁCTER DE <strong>PERSONA FÍSICA O REPRESENTANTE LEGAL</strong> A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ <strong>"EL PROVEEDOR"</strong>, AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:
        </div>
        ...
        <div style="margin-top: 15px;">
            ...
            <div style="margin-top: 10px;">
                ...
                <div style="margin-left: 20px; margin-top: 5px;">6. MANIFIESTA <strong>"EL MUNICIPIO"</strong> QUE TIENE EN SU HABER RECURSOS PECUNIARIOS PROVENIENTES DE PARTICIPACIONES FEDERALES PARA EL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</strong> CONFORME AL PRESUPUESTO DE EGRESOS DE LA FEDERACIÓN PARA EL EJERCICIO FISCAL 2026.</div>
                <div style="margin-left: 20px; margin-top: 5px;">7. QUE LA ADJUDICACIÓN DEL CONTRATO SE REALIZÓ MEDIANTE PROCEDIMIENTO POR LICITACIÓN PÚBLICA <strong>LPNP-<span class="campo-dato"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span></strong>, DE CONFORMIDAD CON LOS ARTÍCULOS 29, 30 FRACCIÓN I, 32, 33, 34, 35, 36, 37, 38, 39, 40 Y 41 DE LA LEY DE CONTRATACIÓN PÚBLICA DEL ESTADO DE MÉXICO Y MUNICIPIOS Y 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 71 Y 72 DE SU RESPECTIVO REGLAMENTO.</div>
            </div>
        </div>

        <div class="numero-pagina">15 DE 19</div>
    </div>
</div>

<!-- HOJA 16: ANEXO 5 - DECLARACIONES PROVEEDOR Y DEFINICIONES -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
            <span>AYUNTAMIENTO DE TEMASCALCINGO 2025-2027</span>
        ...
        <div style="margin-top: 5px;">
            ...
            <div style="margin-left: 20px; margin-top: 5px;">1. QUE ES UNA EMPRESA CONSTITUIDA LEGALMENTE DE ACUERDO CON LAS LEYES DE NUESTRO PAÍS, QUE, CON LA SUSCRIPCIÓN DEL PRESENTE CONTRATO, CUMPLE CON UNO DE LOS FINES ESTABLECIDOS DENTRO DE SU OBJETO SOCIAL, SEGÚN LO ACREDITA CON ACTA CONSTITUTIVA <span class="campo-dato"><?= isset($data[0]['num_acta_cons']) ? esc($data[0]['num_acta_cons']) : '' ?></span>, VOLUMEN <span class="campo-dato"><?= isset($data[0]['volumen_re']) ? esc($data[0]['volumen_re']) : '' ?></span>, DE FECHA <span class="campo-dato"><?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?></span>, ANTE LA FE DEL NOTARIO PÚBLICO <span class="campo-dato"><?= isset($data[0]['notario']) ? esc($data[0]['notario']) : '' ?></span>, TITULAR DE LA NOTARIA PÚBLICA <span class="campo-dato"><?= isset($data[0]['titular']) ? esc($data[0]['titular']) : '' ?></span>; MISMA QUE CUENTA CON EL REGISTRO PÚBLICO DE LA PROPIEDAD Y COMERCIO CON NÚMERO DE INSCRIPCIÓN <strong>LIBRO <span class="campo-dato"><?= isset($data[0]['num_libro']) ? esc($data[0]['num_libro']) : '' ?></span>, BAJO LA PARTIDA NÚMERO _____________________, VOLUMEN <span class="campo-dato"><?= isset($data[0]['volumen_re']) ? esc($data[0]['volumen_re']) : '' ?></span> DE FECHA <span class="campo-dato"><?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?></span>, DEL AÑO <span class="campo-dato"><?= isset($data[0]['created_at']) ? date('Y', strtotime($data[0]['created_at'])) : '' ?></span>.</strong></div>
            <div style="margin-left: 20px; margin-top: 5px;">2. QUE PARA EFECTOS DEL PRESENTE CONTRATO _________________________, SEÑALA COMO SU DOMICILIO FISCAL UBICADO EN <span class="campo-dato"><?= isset($data[0]['domicilio_proveedor']) ? esc($data[0]['domicilio_proveedor']) : '' ?></span>, NÚMERO DE TELÉFONO <span class="campo-dato"><?= isset($data[0]['telefono_principal']) ? esc($data[0]['telefono_principal']) : '' ?></span> Y CORREO ELECTRÓNICO <span class="campo-dato"><?= isset($data[0]['correo_proveedor']) ? esc($data[0]['correo_proveedor']) : '' ?></span>.</div>
            <div style="margin-left: 20px; margin-top: 5px;">3. QUE CUENTA CON EL DEBIDO REGISTRO FEDERAL DE CONTRIBUYENTES <span class="campo-dato"><?= isset($data[0]['rfc']) ? esc($data[0]['rfc']) : '' ?></span>, CON ACTIVIDAD ECONÓMICA <span class="campo-dato"><?= isset($data[0]['giro_economico']) ? esc($data[0]['giro_economico']) : '' ?></span>.</div>
            <div style="margin-left: 20px; margin-top: 5px;">4. QUE CONOCE LAS ESPECIFICACIONES DEL PROCEDIMIENTO DE LICITACIÓN PÚBLICA NACIONAL PRESENCIAL REFERENTE AL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</strong> EL CUAL LLEVA A CABO EL MUNICIPIO DE TEMASCALCINGO Y DEMÁS DOCUMENTOS QUE SE ENCUENTRAN INTEGRADOS AL EXPEDIENTE QUE SE FORMÓ CON MOTIVO DEL PROCEDIMIENTO DE ADQUISICIÓN ANTES REFERIDO.</div>
        ...
        <div style="margin-top: 10px;">
            ...
            <div style="margin-top: 5px;">
                ...
                <div style="margin-left: 20px; margin-top: 5px; text-align: justify;">EL PRESENTE CONTRATO TIENE POR OBJETO QUE <strong>"EL PROVEEDOR"</strong> SUMINISTRE A <strong>"EL MUNICIPIO" <span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span></strong> DE CALIDAD COMPROBADA Y APTOS PARA SU CONSUMO, DESTINADOS A SUMINISTRAR A LAS ÁREAS Y DEPENDENCIAS MUNICIPALES QUE REQUIERAN ESTOS PRODUCTOS, GARANTIZANDO SU CORRECTA CONSERVACIÓN, INOCUIDAD Y DISPONIBILIDAD PARA EL USO DEL PERSONAL Y VISITANTES.</div>
        ...
        <div class="numero-pagina">16 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 17: ANEXO 5 - CLÁUSULAS SEGUNDA A DÉCIMA SEGUNDA -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div style="margin-top: 5px;">
            ...
            <div style="margin-left: 20px; margin-top: 5px; text-align: justify;">LA CANTIDAD A PAGAR POR PARTE DE <strong>"EL MUNICIPIO"</strong> SERÁ DE UN MONTO MÁXIMO POR LA CANTIDAD DE <strong><?= numeroALetrasBases($total) ?></strong> INCLUIDO EL IMPUESTO AL VALOR AGREGADO I.V.A. Y UN MONTO MÍNIMO POR LA CANTIDAD DE <strong><?= numeroALetrasBases($total * 0.60) ?></strong>; INCLUIDO EL IMPUESTO AL VALOR AGREGADO I.V.A., DIVIDIDO EN PARCIALIDADES NECESARIAS Y A LA CORRECTA PRESENTACIÓN DE LAS FACTURAS, POR EL PERIODO COMPRENDIDO DEL <?= isset($data[0]['created_at']) ? date('d/m/Y', strtotime($data[0]['created_at'])) : '' ?>.</div>
        </div>
        ...
        <div style="margin-top: 10px;">
            ...
            <div style="margin-left: 20px; margin-top: 5px;"><strong>"LAS PARTES"</strong> ACUERDAN QUE EL PAGO POR EL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</strong> OBJETO DEL PRESENTE CONTRATO, SE CUBRIRÁ DE LA MANERA SIGUIENTE:</div>
        ...
        <div style="margin-top: 10px;">
            ...
            <div style="margin-left: 40px; margin-top: 5px;">I. ENTREGAR A EL MUNICIPIO DE TEMASCALCINGO, MÉXICO EL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</strong> EN TIEMPO, FORMA Y CALIDAD.</div>
            <div style="margin-left: 40px; margin-top: 5px;">II. INFORMAR A <strong>"EL MUNICIPIO"</strong> DE CUALQUIER ANOMALÍA QUE SE PRESENTE DURANTE LA EJECUCIÓN DEL PRESENTE CONTRATO, EN CUANTO IMPIDA O DIFICULTE LLEVAR A CABO EL PROCEDIMIENTO REFERENTE AL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>"</strong> COMUNICAR POR ESCRITO OPORTUNAMENTE A <strong>"EL MUNICIPIO"</strong> CUALQUIER CAMBIO DE DOMICILIO.</div>
        ...
        <div style="margin-top: 10px;">
            ...
            <div style="margin-left: 20px; margin-top: 5px;">
                <strong>I. CUMPLIMIENTO DE CONTRATO:</strong> SE CONSTITUIRÁ POR EL 10% DEL IMPORTE DEL SUBTOTAL DEL CONTRATO POR LA CANTIDAD DE <strong><?= numeroALetrasBases($subtotal * 0.10) ?></strong>, DENTRO DE LOS DIEZ DÍAS HÁBILES POSTERIORES A LA FIRMA DE CONTRATO, Y ESTARÁ VIGENTE HASTA EL CUMPLIMIENTO DEL PRESENTE.
            </div>
        ...
        <div style="margin-top: 10px;">
            ...
            <div style="margin-left: 20px; margin-top: 5px;"><strong>"LAS PARTES"</strong> ACUERDAN QUE, PARA EL ADECUADO CUMPLIMIENTO DEL OBJETO DEL PRESENTE CONTRATO, TANTO <strong>"EL MUNICIPIO"</strong> COMO <strong>"EL PROVEEDOR"</strong> DESIGNARÁN AL PERSONAL RESPONSABLE DE SUPERVISAR, VERIFICAR Y DAR SEGUIMIENTO A LA CORRECTA EJECUCIÓN DEL <strong>"<span class="campo-dato"><?= isset($data[0]['nombre_estudio']) ? esc($data[0]['nombre_estudio']) : '' ?></span>".</strong></div>
        </div>
        ...
        <div class="numero-pagina">17 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 18: ANEXO 5 - CLÁUSULAS DÉCIMA TERCERA A VIGÉSIMA -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div class="numero-pagina">18 DE 19</div>
    </div>
</div>

<!-- ========================================== -->
<!-- HOJA 19: ANEXO 5 - FIRMAS -->
<!-- ========================================== -->
<div class="hoja">
    <div class="contenido-hoja">
        <div class="encabezado-logo">
        ...
        <div style="margin-top: 15px; border: 1px solid #000;">
            ...
            <div style="text-align: center; padding: 15px;">
                <div style="margin-top: 20px;"></div>
                <span class="campo-dato"><?= isset($data[0]['nombre_proveedor']) ? esc($data[0]['nombre_proveedor']) : '' ?></span><br>
                <strong>EN SU CARÁCTER DE PERSONA <span class="campo-dato"><?= isset($data[0]['tipo_persona']) ? esc($data[0]['tipo_persona']) : '' ?></span> O</strong><br>
                <strong>REPRESENTANTE LEGAL</strong>
            </div>
        </div>

        <div class="numero-pagina">19 DE 19</div>
    </div>
</div>
