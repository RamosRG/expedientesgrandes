...
<head>
    <meta charset="UTF-8">
    <title>Contrato Administrativo</title>
    <!--[if gte mso 9]>
    <xml>
        <w:WordDocument>
            <w:View>Print</w:View>
...
<body>
    ...
    <div class="hoja">
        <div class="contenido-hoja">
            ...
            <div style="margin: 10px 0;">[MTM/CAYS/PF/<span class="campo campo-mediano"><?= isset($data[0]['no_licitacion']) ? esc($data[0]['no_licitacion']) : '' ?></span>]</div>

            <div style="font-weight: bold; font-size: 12pt; text-align: center; margin: 20px 0;">CONTRATO ADMINISTRATIVO ABIERTO PARA<br>EL "SUMINISTRO DE ARTÍCULOS DE <span class="campo campo-largo"><?= isset($data[0]['catalogo']) ? esc($data[0]['catalogo']) : '' ?></span>"</div>

            <div style="text-align: justify; margin-bottom: 15px;">CONTRATO ADMINISTRATIVO QUE CELEBRAN POR UNA PARTE EL MUNICIPIO CONSTITUCIONAL DE TEMASCALCINGO, MÉXICO, REPRESENTADO EN ESTE ACTO POR LA <strong>C. VERÓNICA MORENO MARTÍNEZ</strong>, EN SU CARÁCTER DE <strong>PRESIDENTA MUNICIPAL CONSTITUCIONAL</strong>; <strong>C. RAMIRO GALINDO REYES</strong>, SECRETARIO DEL AYUNTAMIENTO; <span class="campo campo-largo"><?= isset($data[0]['coordinador']) ? esc($data[0]['coordinador']) : '' ?></span> <span class="campo campo-mediano"><?= isset($data[0]['area']) ? esc($data[0]['area']) : '' ?></span> Y ÁREA USUARIA; QUIÉN EN LO SUCESIVO Y PARA LOS EFECTOS DEL PRESENTE SE LE DENOMINARÁ <strong>"EL MUNICIPIO"</strong>; Y POR OTRA PARTE EL <span class="campo campo-largo"><?= isset($data[0]['proveedor']) ? esc($data[0]['proveedor']) : '' ?></span>, EN SU CARÁCTER DE PERSONA FÍSICA A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ <strong>"EL PROVEEDOR"</strong>, AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:</div>
            ...
            <div class="declaracion-item">5. QUE TIENE ESTABLECIDO SU DOMICILIO EN <span class="campo campo-largo"><?= isset($data[0]['direccion_completa']) ? esc($data[0]['direccion_completa']) : 'PALACIO MUNICIPAL, TEMASCALCINGO, MÉXICO' ?></span>, MISMO QUE SE SEÑALA PARA LOS FINES Y EFECTOS LEGALES DEL PRESENTE INSTRUMENTO.</div>
            <div class="declaracion-item">6. MANIFIESTA <strong>"EL MUNICIPIO"</strong> QUE TIENE EN SU HABER RECURSOS PECUNIARIOS PROVENIENTES DE PARTICIPACIONES FEDERALES PARA EL <span class="campo campo-mediano">"SUMINISTRO DE ARTÍCULOS DE <?= isset($data[0]['catalogo']) ? esc($data[0]['catalogo']) : '' ?></span>" CONFORME AL PRESUPUESTO DE EGRESOS DE LA FEDERACIÓN PARA EL EJERCICIO FISCAL 2026.</div>
    ...
    <div class="hoja">
        <div class="contenido-hoja">
            ...
            <div class="texto-justificado">ASÍ MISMO, <strong>"LAS PARTES"</strong> ACUERDAN QUE:</div>
            ...
            <div class="texto-justificado">LOS BIENES OBJETO DEL PRESENTE CONTRATO SE DETALLAN EN LA TABLA SIGUIENTE, LA CUAL FORMA PARTE INTEGRAL DE ESTA CLÁUSULA E INCLUYE DESCRIPCIÓN, CANTIDAD, UNIDAD DE MEDIDA Y ESPECIFICACIONES DE CADA ARTÍCULO:</div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    foreach ($productos as $index => $producto): 
                        ...
                        $precioUnitario = isset($producto['precio_unitario']) ? floatval($producto['precio_unitario']) : 0;
                        $subtotalProducto = isset($producto['subtotal']) ? floatval($producto['subtotal']) : ($cantidad * $precioUnitario);
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="centrado"><?= isset($producto['unidad_medida']) ? esc($producto['unidad_medida']) : '' ?></td>
                            <td><?= isset($producto['marca_modelo']) ? esc($producto['marca_modelo']) : '' ?></td>
                            <td class="centrado">$<?= number_format($precioUnitario, 2) ?></td>
                            <td class="centrado">$<?= number_format($subtotalProducto, 2) ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            ...
            <div style="text-align: right; margin-top: -10px;">
                <span class="campo campo-mediano"><?= isset($data[0]['subtotal_texto_completo']) ? esc($data[0]['subtotal_texto_completo']) : '' ?></span> cantidad en texto.
            </div>
            ...
            <table style="width: auto; float: right; border: none;">
                <tr style="border: none;">
                    ...
                    <td style="border: none;" class="celda-editable">$<?= number_format($subtotal, 2) ?></td>
                </tr>
                <tr style="border: none;">
                    <td style="border: none;">I.V.A.</td>
                    <td style="border: none;">:</td>
                    <td style="border: none;" class="celda-editable">$<?= number_format($iva, 2) ?></td>
                </tr>
                <tr style="border: none;">
                    <td style="border: none;">TOTAL</td>
                    <td style="border: none;">:</td>
                    <td style="border: none;" class="celda-editable">$<?= number_format($total, 2) ?></td>
                </tr>
            </table>
            <div class="clearfix"></div>

            <div class="clausula"><strong>SEGUNDA. -- MONTOS.</strong> LA CANTIDAD A PAGAR POR PARTE DE <strong>"EL MUNICIPIO"</strong> SERÁ DE UN MONTO MÁXIMO POR LA CANTIDAD DE <strong><span class="campo campo-corto">$<?= number_format($total, 2) ?></span>; INCLUIDO EL IMPUESTO AL VALOR AGREGADO I.V.A.</strong> Y UN MONTO MÍNIMO POR LA CANTIDAD DE <strong><span class="campo campo-corto">$<?= number_format($subtotal, 2) ?></span>; INCLUIDO EL IMPUESTO AL VALOR AGREGADO I.V.A.,</strong> DIVIDIDO EN PARCIALIDADES NECESARIAS Y A LA CORRECTA PRESENTACIÓN DE LAS FACTURAS, POR EL PERIODO COMPRENDIDO DEL <span class="campo campo-mediano"><?= isset($data[0]['created_at']) ? date('d \D\E F \D\E Y', strtotime($data[0]['created_at'])) : '' ?></span>.</div>
    ...
    <div class="hoja">
        <div class="contenido-hoja">
            ...
            <div class="declaracion-item">I. <strong>CUMPLIMIENTO DE CONTRATO:</strong> EL CHEQUE DE CAJA, CHEQUE CERTIFICADO O FIANZA SE CONSTITUIRÁ POR EL 10% DEL IMPORTE DEL SUBTOTAL DEL CONTRATO (SIN INCLUIR EL IMPUESTO AL VALOR AGREGADO), DESPUÉS DE LOS DIEZ DÍAS HÁBILES A LA FIRMA DE CONTRATO, POR LA CANTIDAD DE <strong><span class="campo campo-corto">$<?= number_format($subtotal * 0.10, 2) ?></span></strong> Y ESTARÁ VIGENTE HASTA EL CUMPLIMIENTO DEL PRESENTE CONTRATO.</div>
            ...
            <div class="texto-justificado">SI TRANSCURRIDO EL PLAZO SEÑALADO EN EL PRIMER PÁRRAFO <strong>"EL PROVEEDOR"</strong> NO HUBIERE PRESENTADO LA GARANTÍA DE CUMPLIMIENTO RESPECTIVA, <strong>"EL MUNICIPIO"</strong> NO FORMALIZARÁ EL PRESENTE INSTRUMENTO.</div>
            ...
            <div class="texto-justificado">EN CASO DE QUE <strong>"EL MUNICIPIO"</strong> OPTE POR LA RESCISIÓN DEL CONTRATO; <strong>"EL PROVEEDOR"</strong> ESTARÁ OBLIGADO A PAGAR DAÑOS Y PERJUICIOS, OCASIONADOS A <strong>"EL MUNICIPIO"</strong>.</div>
    ...
    <div class="hoja">
        <div class="contenido-hoja">
            ...
            <div class="texto-justificado">UNA VEZ LEÍDO EL PRESENTE CONTRATO Y CONFORMES CON SU CONTENIDO, PROCEDEN A RATIFICAR EN TODAS Y CADA UNA DE SUS PARTES FIRMÁNDOLO POR TRIPLICADO, AL CALCE Y AL MARGEN PARA DEBIDA CONSTANCIA LEGAL, EN EL MUNICIPIO DE TEMASCALCINGO, MÉXICO, A <span class="campo campo-mediano"><?= isset($data[0]['created_at']) ? date('d \D\E F \D\E Y', strtotime($data[0]['created_at'])) : '' ?></span>.</div>
