...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>CONTRATO ABIERTO DE PRESTACIÓN</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>Contrato Abierto de Presentación</span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Contrato Abierto de Presentación Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/contratoPresentacionLista.js"></script>
