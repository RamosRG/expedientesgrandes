...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>CONTRATO ADMINISTRATIVO ABIERTO LP</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>CONTRATO ADMINISTRATIVO ABIERTO LP</span>
            </div>
        </nav>
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Contrato Administrativo LP Finalizados</h2>
    ...
    <script src="../../public/js/procesosInternos/contratoAdminDosLista.js"></script>
