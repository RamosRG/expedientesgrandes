...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>CUMPLIMIENTO DE PROPUESTAS LP</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>CUMPLIMIENTO DE PROPUESTAS LP</span>
            </div>
        </nav>
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Cumplimiento de Propuestas Lp Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/cumplimientoPropuestasLista.js"></script>
