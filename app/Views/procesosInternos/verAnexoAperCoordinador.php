...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>ACTA DE PRESENTACIÓN Y APERTURA DE PROPUESTAS IR</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>ACTA DE PRESENTACIÓN Y APERTURA DE PROPUESTAS IR</span>
            </div>
                            <div class="acciones-superior">
        <a href="<?= '/expedientesGrandes.temascalcingo.gob.mx/procesosInternos/verDocumentos/3' ?>" class="btn-volver">
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Acta de Presentacion y Apertura IR Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/anexoAperCoordinadorLista.js"></script>
