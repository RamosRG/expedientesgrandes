...
<nav class="portal-nav">
    ...
    <script src="http://localhost/expedientesGrandes.temascalcingo.gob.mx/public/js/procesosInternos/obtenerArchivosDelProcedimiento.js"></script>
