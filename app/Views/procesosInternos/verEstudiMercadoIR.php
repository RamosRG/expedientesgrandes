...
<body>
    ...
    <div class="container">
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Estudio Mercado Tabla IR Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/EstudioMercadoIRLista.js"></script>
