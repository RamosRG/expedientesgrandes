...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>PROPUESTA TÉCNICA BIENES A COTIZAR</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>PROPUESTA TÉCNICA BIENES A COTIZAR</span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Propuestas Técnicas, Bienes a Cotizar Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/AnexoEquiposLista.js"></script>
