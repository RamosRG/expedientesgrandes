...
<body>
    ...
    <div class="container">
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Lista de Compra LP Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/bitacoraCompraLista.js"></script>
