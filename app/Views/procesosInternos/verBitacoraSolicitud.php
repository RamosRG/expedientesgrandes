...
<body>
    ...
    <div class="container">
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>BITÁCORA DE SOLICITUD </span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Bitácoras de Solicitud Finalizados</h2>
    ...
    <script src="../../public/js/procesosInternos/BitacoraSolicitudLista.js"></script>
