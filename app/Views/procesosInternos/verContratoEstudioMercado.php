...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>Contrato de Estudio de Mercado</h1>
        </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Contrato de Estudio Mercado Finalizados</h2>
    ...
    <script src="../../public/js/procesosInternos/contratoEstudioMercadoLista.js"></script>
