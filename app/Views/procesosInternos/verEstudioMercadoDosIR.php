...
<body>
    ...
    <div class="container">
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>ESTUDIO MERCADO DOS IR</span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Estudio Mercado Dos IR Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/EstudioMercadoDosIRLista.js"></script>
