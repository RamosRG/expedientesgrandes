...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>Contrato de Estudio de Mercado Tabla Productos</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>Estudio Mercado Tabla Productos</span>
            </div>
        </nav>
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Estudio Mercado Tabla Productos Finalizados</h2>
    ...
    <script src="../../public/js/procesosInternos/contratoEstudioMercaLista.js"></script>
