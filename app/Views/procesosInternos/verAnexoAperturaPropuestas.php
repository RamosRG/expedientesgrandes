...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>ANEXO APERTURA DE PROPUESTAS</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>ANEXO APERTURA DE PROPUESTAS</span>
            </div>
                            <div class="acciones-superior">
        <a href="<?= '/expedientesGrandes.temascalcingo.gob.mx/procesosInternos/verDocumentos/1' ?>" class="btn-volver">
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Anexos de Apertura Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/anexoAperturaPropuestasLista.js"></script>
