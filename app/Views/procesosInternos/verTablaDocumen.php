...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>Tabla de Documentacion LP</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>Tabla de Documentacion LP</span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Tabla de Documentacion LP Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/tablaDocumenLista.js"></script>
