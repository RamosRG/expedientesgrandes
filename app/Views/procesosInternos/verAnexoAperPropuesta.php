...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>ACTA PRESENTACIÓN APERTURA PROPUESTA IR</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>ACTA PRESENTACIÓN APERTURA PROPUESTA IR</span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Anexos de Acta Presentación Apertura Propuesta IR Finalizados</h2>
    ...
    <script src="../../public/js/procesosInternos/AnexoAperPropuestaLista.js"></script>
