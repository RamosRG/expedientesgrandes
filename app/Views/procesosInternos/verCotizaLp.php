...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>INVITACIÓN AL ESTUDIO DE MERCADO LP</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>INVITACIÓN AL ESTUDIO DE MERCADOS LP</span>
            </div>
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Invitacion al Estudio de Mercado Lp Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/cotizaLpLista.js"></script>
