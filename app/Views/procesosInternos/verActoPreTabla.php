...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h1>Actas de Presentacion Tabla LP</h1>
        </div>
        ...
        <nav class="portal-nav" style="margin-bottom: 30px;">
            <div class="breadcrumb">
                ...
                <span>Actas de Presentacion Tabla LP</span>
            </div>
        </nav>
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Actas de Presentacion Tabla Finalizadas</h2>
    ...
    <script src="../../public/js/procesosInternos/actoPreTablaLista.js"></script>
