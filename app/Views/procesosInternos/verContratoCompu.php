...
<body>
    ...
    <div class="container">
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Contratos Abiertos IR Finalizados</h2>
    ...
    <script src="../../public/js/procesosInternos/contratoCompuLista.js"></script>
