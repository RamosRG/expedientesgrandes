...
<body>
    ...
    <div class="container">
        ...
        <!-- DATOS GENERALES -->
        <div class="card">
            <h2>Invitaciones de Estudios de Mercado Finalizados IR</h2>
    ...
    <script src="../../public/js/procesosInternos/InvitacionEstudioLista.js"></script>
